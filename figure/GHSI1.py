...
th3 = Process(target=Finder_IETE, args=(1, heure, start_1h))
th4 = Process(target=Finder_IETE, args=(4, heure, start_1h))
th5 = Process(target=Finder_IETE, args=(1, jour, start_1d))
